...
# 20 = max player speed
const STAMINA_FACTOR: float = 1.0 / (FULL_TIME_SECONDS * TICKS_LOGIC * 20)
...
const SCREEN_SETUP_INITIAL: String = "res://src/screens/setup/setup_initial/setup_initial.tscn"
